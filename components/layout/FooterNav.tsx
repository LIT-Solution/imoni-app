...
export default function FooterNav() {
  return (
    <footer className="relative z-10 bg-[#0D0F1A] overflow-hidden">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-10 py-10">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li><Link href="/acheteur" className="text-white/40 hover:text-white text-sm transition-colors">Acheteur</Link></li>
              <li><Link href="/vendeur" className="text-white/40 hover:text-white text-sm transition-colors">Vendeur</Link></li>
              <li><Link href="/pro-immo" className="text-white/40 hover:text-white text-sm transition-colors">Pro de l&apos;immo</Link></li>
              <li><Link href="/autres-pros" className="text-white/40 hover:text-white text-sm transition-colors">Autres pros</Link></li>
            </ul>
          </div>
