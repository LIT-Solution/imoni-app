      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              <p className="text-white font-bold text-xl leading-snug">
                Imoni, l&apos;application qui change<br />
          ...
          <div className="flex flex-col items-center lg:items-end gap-2 shrink-0">
            <a
              href="#"
              className="group relative inline-flex items-center gap-2 bg-white text-[#6D28D9] font-semibold px-7 py-3 rounded-full overflow-hidden transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg"
            >
