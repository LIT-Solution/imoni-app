    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-8 w-full">
        <div className="grid lg:grid-cols-2 gap-8 items-center min-h-[calc(100vh-6rem)]">
          ...
          <div className="flex flex-col justify-center space-y-6 -mt-16">
            <div className="reveal-left">
              <span className="inline-flex items-center border-2 border-[#F59E0B]/50 text-[#F59E0B] text-[11px] font-bold px-4 py-1.5 rounded-full tracking-widest uppercase bg-[#F59E0B]/10">
                Pour les vendeurs
              </span>
            </div>

            <div className="reveal-left reveal-delay-1">
              <h1 className="text-4xl sm:text-5xl lg:text-[3.6rem] font-extrabold text-white leading-[1.08]">
                Votre bien mérite
              </h1>
              <h1 className="text-4xl sm:text-5xl lg:text-[3.6rem] font-extrabold leading-[1.08]">
            ...
            <p className="reveal-left reveal-delay-2 text-white/70 text-[1.05rem] leading-relaxed max-w-md">
              Imoni révolutionne la vente immobilière.<br />
              Rencontrez des acquéreurs qualifiés, gardez le contrôle<br />
              et vendez dans les meilleures conditions.
            </p>

            <ul className="reveal-left reveal-delay-3 space-y-2.5">
              {[
              ...
              <li className="flex items-center gap-3 text-[#E91E8C] font-bold text-sm">
                <svg className="w-5 h-5 shrink-0" fill="#E91E8C" viewBox="0 0 24 24">
            ...
            <div className="reveal reveal-delay-4">
              <a
                href="#"
                className="group relative inline-flex items-center gap-3 bg-gradient-to-r from-[#8B5CF6] via-[#E91E8C] to-[#FF8C00] text-white font-semibold text-lg px-8 py-4 rounded-full overflow-hidden transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-purple-500/30"
              >
          ...
          <div className="reveal-right reveal-delay-2 flex items-center justify-center gap-3">
            ...
            {/* Téléphone */}
            <div style={{ filter: "drop-shadow(0 0 40px rgba(139,92,246,0.5))", flexShrink: 0, transform: "translateY(-40px)" }} className="w-[240px] sm:w-[280px] lg:w-[320px]">
