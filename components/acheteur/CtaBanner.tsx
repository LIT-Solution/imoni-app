  ...
  return (
    <section ref={sectionRef} className="relative z-10 bg-transparent px-4 sm:px-6 lg:px-8 -mt-28 pb-8">
      <div className="max-w-7xl mx-auto">
        <div
          className="reveal-scale rounded-2xl px-5 sm:px-8 lg:px-12 py-8 sm:py-10 lg:py-14 flex flex-col lg:flex-row items-center justify-between gap-6"
        ...
        >
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 mt-2.5">
          ...
          <div className="flex flex-col items-center lg:items-end gap-2 shrink-0">
            <a
              href="#"
              className="group relative inline-flex items-center gap-2 bg-linear-to-r from-[#8B5CF6] via-[#E91E8C] to-[#FF8C00] text-white font-semibold px-7 py-3 rounded-full overflow-hidden transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-pink-500/30"
            >
