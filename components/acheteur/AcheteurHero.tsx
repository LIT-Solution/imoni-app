    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 sm:pt-24 pb-8 w-full">
        <div className="grid lg:grid-cols-2 gap-8 items-center min-h-[calc(100vh-6rem)]">
          ...
          <div className="reveal-right reveal-delay-2 relative flex justify-center lg:justify-center items-center mt-4 sm:-mt-16 lg:-ml-16" style={{ perspective: "1200px" }}>
            <div className="relative">
              ...
              <div className="hidden lg:flex absolute -right-16 top-[15%] items-center gap-2.5 bg-white rounded-xl px-4 py-3 shadow-lg shadow-black/10" style={{ animation: "breathe2 4s ease-in-out infinite" }}>
              ...
              <div className="hidden lg:flex absolute -left-8 bottom-[15%] items-center gap-2.5 bg-white rounded-xl px-4 py-3 shadow-lg shadow-black/10" style={{ animation: "breathe3 4.5s ease-in-out infinite" }}>
