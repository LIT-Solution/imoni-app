...
function PriceCard({ plan }: { plan: { label: string; price: number; color: string } }) {
  ...
  return (
    <div ref={ref} className="flex-1 text-center border border-gray-200 rounded-2xl py-6 px-4">
      <p className="text-gray-500 font-semibold text-xs uppercase tracking-wider mb-3">
        {plan.label}
      </p>
      <div className="flex items-baseline justify-center gap-1">
        <span className="text-4xl sm:text-5xl font-extrabold text-[#0D0F1A]">{value}</span>
        <span className="text-lg font-semibold text-gray-400">&euro;</span>
        <span className="text-sm text-gray-400">/ mois</span>
      </div>
      <span
        className="inline-block mt-3 text-[10px] font-bold uppercase tracking-wider px-4 py-1 rounded-full text-white"
...
export default function ProCta() {
  ...
  return (
    <section ref={sectionRef} className="bg-[#F8F4FF] py-20 sm:py-28">
      <div className="mx-auto px-4 sm:px-6">
        ...
        <div className="reveal reveal-delay-1 flex flex-col lg:flex-row items-stretch gap-0 rounded-3xl shadow-xl">
          ...
          {/* Left — Pricing */}
          <div className="bg-white px-8 sm:px-12 py-6 flex flex-col justify-center lg:w-[38%] shrink-0 rounded-l-3xl">
            <span className="text-[#8B5CF6] font-semibold text-xs uppercase tracking-widest mb-8 block">
          ...
          {/* Right — CTA banner */}
          <div
            className="flex-1 px-8 sm:px-12 py-6 flex items-center gap-8 relative rounded-r-3xl"
          ...
          >
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-3">
                <a href="#" className="flex items-center gap-2.5 bg-black hover:bg-gray-900 text-white px-4 py-2.5 rounded-xl transition-colors">
        ...
        {/* Bottom trust bar */}
        <div className="reveal reveal-delay-3 flex flex-wrap items-center justify-center gap-8 sm:gap-12 mt-12 text-gray-400 text-xs">
