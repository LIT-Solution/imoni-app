    ...
    <section ref={sectionRef} className="py-16 sm:py-20 lg:py-28 bg-white">
      <div className="max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="reveal-scale text-center mb-8 sm:mb-14">
          <h2 className="text-2xl sm:text-3xl lg:text-[2rem] 2xl:text-[2.6rem] font-extrabold text-[#0D0F1A] leading-tight">
        ...
        <div className="reveal mt-12 bg-gray-50 rounded-2xl border border-gray-100 px-6 py-5 flex flex-col sm:flex-row items-start sm:items-center gap-6">
          ...
          <div className="grid grid-cols-3 w-full sm:w-auto sm:flex sm:items-center gap-0">
            <div className="flex items-start gap-2 px-3 sm:px-6">
              <svg className="w-6 h-6 sm:w-8 sm:h-8 text-[#E91E8C] shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.8}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
              <div>
                <p className="text-[#0D0F1A] text-xs sm:text-sm font-bold leading-tight">Sécurisé</p>
                <p className="text-gray-400 text-[10px] sm:text-xs leading-tight">Transactions et données protégées</p>
              </div>
            </div>
            <div className="flex items-start gap-2 px-3 sm:px-6 border-x border-gray-200">
              <Image src="/icones/user-group.svg" alt="" width={32} height={32} className="w-6 h-6 sm:w-8 sm:h-8 shrink-0 mt-0.5" style={{ filter: "invert(19%) sepia(92%) saturate(4000%) hue-rotate(310deg) brightness(90%) contrast(95%)" }} />
              <div>
                <p className="text-[#0D0F1A] text-xs sm:text-sm font-bold leading-tight">Collaboratif</p>
                <p className="text-gray-400 text-[10px] sm:text-xs leading-tight">Une plateforme ouverte et connectée</p>
              </div>
            </div>
            <div className="flex items-start gap-2 px-3 sm:px-6">
              ...
              <div>
                <p className="text-[#0D0F1A] text-xs sm:text-sm font-bold leading-tight">100% Gratuit</p>
                <p className="text-gray-400 text-[10px] sm:text-xs leading-tight">Des services sans frais pour tous</p>
              </div>
            </div>
          </div>
        </div>
