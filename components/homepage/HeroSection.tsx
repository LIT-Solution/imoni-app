...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:pl-0 lg:pr-0 pt-20 sm:pt-24 pb-8 w-full">
        <div className="grid lg:grid-cols-[52%_48%] gap-0 items-start min-h-[calc(100vh-6rem)]">

          {/* Colonne gauche */}
          <div className="flex flex-col justify-start space-y-5 sm:space-y-7 lg:pr-4 pt-8 sm:pt-20 lg:ml-8">
            ...
            <div className="reveal-left reveal-delay-1">
              <h1 className="text-3xl sm:text-5xl lg:text-[4.5rem] font-extrabold text-white leading-[1.08] tracking-tight">
                L&apos;immobilier<br />devrait être
              </h1>
              <h1 className="text-3xl sm:text-5xl lg:text-[4.5rem] font-extrabold leading-[1.08] tracking-tight bg-linear-to-r from-[#E91E8C] via-[#FF4D6D] to-[#FF8C00] bg-clip-text text-transparent">
                une rencontre.
              </h1>
            </div>
          ...
          <div className="reveal-right reveal-delay-2 relative flex justify-center lg:justify-end items-start lg:translate-x-8 pt-0">
            <div className="relative drop-shadow-2xl -translate-y-4 sm:-translate-y-12 translate-x-0 sm:-translate-x-20">
              <div className="relative w-56 sm:w-100 lg:w-140 h-72 sm:h-130 lg:h-180">
                <Image
